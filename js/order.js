function storeData() {
  ...
  function validateData(){
    ...
    var title_check = document.getElementById("title").value;
    var first_check = document.getElementById("first").value;
    var last_check = document.getElementById("last").value;
    var payment_name_check = document.getElementById("cardholder").value;
    var check_card_number = document.getElementById("cardnumber").value;
    ...
    var check_expiration_month = document.getElementById("cardexpirationmonth").value;
    var check_expiration_year = document.getElementById("cardexpirationyear").value;
    var ccv_check = document.getElementById("card-ccv").value;
    var country_check = document.getElementById("country").value;
